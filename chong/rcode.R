...
## ---- cache = TRUE, echo=FALSE, message=FALSE, warning=FALSE, results='asis'----
load('newres4a.RData')
g=gofN(res4)
plot(g)
...
texreg::knitreg( list('Model 4:+gwbdsp terms'=res4, 'Model 5: +Care activity'=res5), single.row = TRUE, scalebox  = .8)
dc$Nurse
